...
% обновления git с LaTeX
% история про установку и как быстро печатать
% забавные факты из ЛЛ
% забавные факты про нейросетки
% рецепты готовки (затеханные, само собой)
