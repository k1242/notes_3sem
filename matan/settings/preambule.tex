...
\renewcommand{\sp}{\mathop{\mathrm{span}}\nolimits}
...
\newcommand*\home{%
  \xrightarrow[\raisebox{0.35 em}{\smash{\ensuremath{\sim}}}]{}%
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\setlength{\headheight}{13pt} % во избежания warning
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
